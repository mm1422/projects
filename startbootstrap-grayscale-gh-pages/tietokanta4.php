...
if(isset($_GET['poista']) && isset($_GET['poistettava_nimi']))
    ...
    $sql = "DELETE FROM tuote WHERE nimi = ?";
    ...
    if ($stmt->affected_rows > 0) {
        echo "Kuntosali tuote nimeltä $poistettava_nimi on nyt poistettu";
        echo "<br><a href='näyttö.html'>Palaa pääsivulle</a>";
    } else {
        echo "Poistaminen epäonnistui koska tämän nimistä tuotetta ei löydetty";
        echo "<br><a href='näyttö.html'>Palaa pääsivulle</a>";
    }
